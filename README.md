...
This project has been derived as a template from [React-Google-Apps-Script](https://github.com/enuchi/React-Google-Apps-Script) by [Elisha Nuchi](https://github.com/enuchi). We thank her support for providing this crucial template for developing complex use-cases with apps script and react for ease.
